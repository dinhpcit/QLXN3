...
{ 
	...
	elseif( empty($error))
	{
						...
						if ( trim($hovaten) != '' )
						{
							if (!empty($hovaten) )
							{
								...
								$data = array(
									...
									"labcode" => "",
									"bphuongphapxetnghiem" => $objWorksheet->getCellByColumnAndRow(31, $i)->getCalculatedValue(),
									"bphuongphapxetnghiem1" => $objWorksheet->getCellByColumnAndRow(31, $i)->getCalculatedValue(),
									"bketquaxetnghiem" =>  $objWorksheet->getCellByColumnAndRow(35, $i)->getValue(),
									"bketquaxetnghiem1" =>  $objWorksheet->getCellByColumnAndRow(35, $i)->getValue(),
									"idfile" => $fileid,
									"uptime" => time(),
								...
								$query = "INSERT INTO `tbl_bmxn_test` (`id`, `mangay`, `madonvi`, `chukymatt`, `mamaubenhpham`, `hinhthuclaymau`, `matt`, `hovaten`, `namsinh`, `gioitinh`, `dienthoai`, `huyennoio`, `xanoio`, `thonnoio`, `nghenghiep`, `noilamviec`, `doituonglaymau`, `lanlaymau`, `odich`, `phanloainoilaymau`, `diadiemnoilaymau`, `huyennoilaymau`, `xanoilaymau`, `thonnoilaymau`, `loaimau`, `donvilaymau`, `maongbenhpham`, `manguoiduoclaymau`, `ngaylaymau`, `hinhthuc`, `loaigop`, `uptime`, `userid`, `filepath`, `qhcode`, `pxcode`,`labcode`,`bphuongphapxetnghiem`,`bphuongphapxetnghiem1`,`bketquaxetnghiem`,`bketquaxetnghiem1`,`idfile`) 
									...
									".$db->dbescape($data['bphuongphapxetnghiem1']).",
									".$db->dbescape($data['bketquaxetnghiem']).",
									".$db->dbescape($data['bketquaxetnghiem1']).",
		...
		{
			$error = "Error: không có file Excel dữ liệu xét nghiệm TEST nhanh";
		}
	}
}
...
$xtpl->assign( 'mlink', DF_BASE_SITEURL . "form/TEST210909.xlsx");
$capchar = capchar();
