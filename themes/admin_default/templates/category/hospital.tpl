...
<table width="100%" style="border-bottom:#CCC 1px solid; padding:3px; background:#EEE">
    <tbody>
        <tr><td>
           ...
           <span class="menu_cate_active"> <a class="gray mytab" href="{link_hospital}" data-toggle="tab">Bệnh viện điều trị</a></span>
              ...
              <!-- BEGIN: loop -->
                 <tr>
                    ...
                    <td class="tc" align="center">
                        ...
                        <!-- BEGIN: del -->
                        &nbsp;&nbsp;
                        <a class="edit_custom_field" href="javascript:void(0)" onclick="delete_colum('{ROW.id}','{ROW.ck}','hospital')">
                        <i class="fa fa-trash" aria-hidden="true"></i></a>
                        <!-- END: del -->
                        <!-- BEGIN: reto -->
                        &nbsp;&nbsp;
                        <a class="edit_custom_field" href="javascript:void(0)" onclick="reto_colum('{ROW.id}','{ROW.ck}','hospital')">
           		...
           		<form action="" method="post" enctype="multipart/form-data" id="iform">
                    ...
                    <div style="padding:10px; border:10px solid #EEE">
                       ...
                       <div class="mt10"> 
                           ...
                           <a class="btn btn-default" href="javascript:void(0);" onclick="javascript:window.location.href='{link_hospital}'">Hủy</a>
                       </div>
                    </div>
                </form>
           </td>
