...
<tr><td valign="top">
        <table width="100%" style="border-bottom:#CCC 1px solid; padding:3px; margin-top:1px" class="list">
            ...
            <tr>
                <td colspan="2">
                    <strong>Nội dung thống kê</strong>
                    Từ mã <input type="text" value="{code_begin}" style="width:80px" name="code_begin" id="code_begin"/>
                    đến mã <input type="text" value="{code_end}" style="width:80px" name="code_end" id="code_end"/>
                    <input type="button" value="Thống kê" onclick="gostatistic()"/>
                </td>
            </tr>
            </tbody>
            <tr>
    ...
    <tbody>
        <tr>
			<td>
				...
				<!-- END: extend -->
                Từ mã <strong>{code_begin}</strong> đến <strong>{code_end}</strong> có <strong>{all_number}</strong> ca bệnh
            </td>
			<td align="right">
...
<table width="100%" class="list" id="myTable04" style="height: 50px">
    <thead class="second">
        <tr>
			...
			<td align="center"><div style="width:80px; display:inline-block"><strong>Kết quả XN</strong></div></td>
			<td align="center"><div style="width:80px; display:inline-block"><strong>Báo cáo ca bệnh</strong></div></td>
