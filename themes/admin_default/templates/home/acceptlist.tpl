...
<table width="100%" style="border-bottom:#CCC 1px solid; padding:3px">
    <tbody>
        <tr>
			<td>
                <input type="button" onClick="go_approve()" value="Duyệt theo tích chọn"/>
                <input type="button" onClick="go_approveall()" value="Duyệt theo danh sách" disabled="disabled"/>
            </td>
    	</tr>
    </tbody>
</table>
    ...
    <input type="hidden" value="1" id="isave" name="save"/>
        <table class="nlist">  
            <tr>
                ...
                <td>
                	<input type="checkbox" value="1" name="ckd" id="ckd" {ckd1}/> <label for="ckd">Chưa duyệt</label>
                </td>
            	<td align="center">
        ...
        <table class="list">  
            <tr>
            	<td>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <button type="button" onClick="duyet_ma()" class="btn btn-info startUpload">Xác nhận và duyệt ({anum} bản ghi)</button> 
