    ...
    <tbody>
        <tr>
			<td width="350">
                ...
                <input type="button" value="Xóa KQXN theo tên file" onClick="go_delkqxn()" disabled="disabled" />
...
<div style="padding: 3px;margin-top:10px">
    ...
    <input type="hidden" value="1" id="isave" name="save"/>
        <table class="nlist">  
            <tr>
            	<td align="center"><strong>Bạn đang chọn xóa thông tin dãy mã bệnh phẩm KQXN theo tên file</strong></td>
            </tr>  
            <tr>
            	<td align="center">
                    <input type="text" name="tenfile" style="width:400px" placeholder="Ví dụ: TI_202109112123_KQXN.xlsx" value="{tenfile}"/>
                </td>
            </tr>
            <tr>
            	<td align="center">
