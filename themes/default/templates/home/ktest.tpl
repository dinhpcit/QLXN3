...
<input type="hidden" value="1" name="save"/>
	<div class="cssRadiusTop">
        <h2 style="font-size: 20px; text-transform:uppercase ">
            <strong style="color:#F60">QUẢN LÝ DỮ LIỆU MẪU</strong>
        </h2>   
        <p>
            <p>Tạo biểu mẫu nhập dữ liệu XN <a href="{mlink}" style="color: #006BFD" target="_blank">tại đây</a> <strong style="color: red">*</strong></p>
    ...
    <div class="cssRadius">
       <div>
           <p>Tải lên file dữ liệu XN *.xls hoặc *.xlsx (sau khi lấy mẫu)<strong style="color: red">*</strong></p>
   ...
   <table>
	...
	<div class="cssRadius">			
		  <div align="center"> 
			  <input type="submit" onclick="this.disabled=true;this.value='Xin vui lòng chờ 1-2 phút...';this.form.submit();" class="btn btn-info startUpload" value="Tải dữ liệu xét nghiệm" style="padding:8px"/> 
		  </div>
	 </div>  
</form>
</div>
