...
<div>
	Kiểm tra lại thông tin dữ liệu mẫu bệnh phẩm và kết quả xét nghiệm (<strong>{tongso} bản ghi</strong>). 
...
<table width="100%" class="list" id="myTable04">
    <thead class="second">
        <tr>
            ...
            <td align="center" style="background:#FC9"><div style="width:100px; display:inline-block"><strong>Ngày nhận mẫu<br />dd/mm/yyyy</strong></div></td>
            <td align="center" style="background:#FC9"><div style="width:100px; display:inline-block"><strong>Giờ nhận mẫu<br />hh:mm</strong></div></td>
            ...
            <td align="center"><div style="width:160px; display:inline-block"><strong>Ngày cập nhật</strong></div></td>
            <td>-</td>
        </tr> 
    </thead> 
    <tbody> 
